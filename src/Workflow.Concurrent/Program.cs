...
AIAgent legalAgent = chatClient.CreateAIAgent(name: "LegalAgent", instructions: "You are a legal agent that need to evaluate if a text is legal (use max 200 chars)");
AIAgent spellingErrorAgent = chatClient.CreateAIAgent(name: "SpellingErrorAgent", instructions: "You are a spelling expert (use max 200 chars)");
