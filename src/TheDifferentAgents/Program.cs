...
AIAgent aiAgentFromResponsesClient = rawOpenAiClient.GetResponsesClient().AsAIAgent(model: model);
...
ChatClientAgent chatClientAgentFromResponsesClient = rawOpenAiClient.GetResponsesClient().AsAIAgent(model);
