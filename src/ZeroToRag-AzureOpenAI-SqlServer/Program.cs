...
//todo - CommunityToolkit.VectorData.SqlServer (For VectorStore)
...
VectorStore store = new SqlServerVectorStore(sqlServerConnectionString, new SqlServerVectorStoreOptions
{
